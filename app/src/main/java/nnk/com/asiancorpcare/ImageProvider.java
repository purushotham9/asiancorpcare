...
public class ImageProvider extends ContentProvider {
     ...
     */
    private SaveLoginDatabase dbHelper;

    @Override
    public boolean onCreate() {
        dbHelper = new SaveLoginDatabase(getContext());
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            case PICTURES:
                ...
                cursor = database.query(SaveLoginDatabase.TABLE_EXPENSES, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            case PICTURES_ID:
